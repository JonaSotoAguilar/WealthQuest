...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Board_Action = m_Board.FindAction("Action", throwIfNotFound: true);
        // Player
    ...
    ~@Controls()
    {
        Debug.Assert(!m_Board.enabled, "This will cause a leak and performance issues, Controls.Board.Disable() has not been called.");
    ...
    private readonly InputAction m_Board_Action;
    public struct BoardActions
    {
        private @Controls m_Wrapper;
        public BoardActions(@Controls wrapper) { m_Wrapper = wrapper; }
        public InputAction @Action => m_Wrapper.m_Board_Action;
