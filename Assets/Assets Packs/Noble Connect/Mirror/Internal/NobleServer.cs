...
namespace NobleConnect.Mirror
{
    ...
    public class NobleServer
    {
        ...
        static public bool ReplacePlayerForConnection(NetworkConnectionToClient conn, GameObject player, uint assetId, ReplacePlayerOptions replacePlayerOptions)
        {
            return NetworkServer.ReplacePlayerForConnection(conn, player, assetId, replacePlayerOptions);
        }
        ...
        {
            return NetworkServer.ReplacePlayerForConnection(conn, player, replacePlayerOptions);
        }
