...
public class PauseMenu : MonoBehaviour
{
    ...
    private void CreateInstance()
    {
        ...
        {
            Debug.LogWarning("Se encontró un duplicado de PauseMenu. Será destruido.");
    ...
    private void OnPauseAction(CallbackContext context)
    {
        if (instance == null)
        {
            Debug.LogWarning("No hay instancia de PauseMenu disponible.");
            return;
        }

        Debug.Log("On Pause Action");
    ...
    public void OpenPauseMenu()
    {
        ...
        {
            Debug.LogWarning("El menú de pausa o su fondo han sido destruidos.");
            return;
        }
