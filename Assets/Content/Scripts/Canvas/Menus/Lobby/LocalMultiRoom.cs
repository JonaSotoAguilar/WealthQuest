...
public class LocalMultiRoom : MonoBehaviour
{
    ...
    public IEnumerator SavePlayerInputs()
    {
        ...
        PlayerStorage.SavePlayerStorage(0, device, controlScheme, characters[0].PlayerName, characters[0].CharacterSelected);
        ...
        for (int i = 1; i < characters.Count; i++)
        {
            ...
            if (playerInput != null)
            {
                ...
                if (device != null)
                {
                    PlayerStorage.SavePlayerStorage(characters[i].Index, device, controlScheme, characters[i].PlayerName, characters[i].CharacterSelected);
                }
                else
                {
