...
public class PlayerDice : MonoBehaviour
{
    ...
    private Vector3 rotationDirection = new Vector3(250f, 250f, 250f); // Dirección inicial de la rotación
    ...
    public IEnumerator StopDice()
    {
        ...
        // Esperar un breve momento antes de verificar el resultado (opcional)
        yield return new WaitForSeconds(0.5f);

        // Verificar el resultado según la orientación de la cámara y la posición del dado.
        CheckResult();

        // Después de 1 segundo, el dado se oculta.
        yield return HideDiceAfterDelay(1f);
    }
